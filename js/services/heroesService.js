app.factory("heroesService", heroesServiceFactory);

function heroesServiceFactory() {
  var factory = () => {
    return new heroesListService();
  };

  return factory;
}

function heroesListService() {
  var service = this;

  service.getHeroes = () => heroes;

  service.getHeroe = (index) => heroes[index];
}
